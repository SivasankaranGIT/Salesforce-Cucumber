...
Background: 
	Given I am logged into salesforce for "VerifyChatBot_HEMHEducationPage3"

@Chatbot
@VerifyChatBot_HEMHEducationPage3 @GCRM-8466
Scenario Outline: Verify that the Chatbot is available on the page and it is responding
	Given Runmode for "VerifyChatBot_HEMHEducationPage3" is Y
	...
	Examples:
	|HE_MHEducation_URL																					 |
	|"https://www-qastg.mheducation.com/highered/home-guest.html"|